        ...
        """Lists the available discovery settings matching the input criteria. This method provides a more flexible search interface than the index method, but searching using this method is more demanding on the system and will not perform to the same level as the index method. The input fields listed below will be used as in the index method, to filter the result, along with the optional query string and XML filter described below.
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param query: This value will be matched against discovery settings, looking to see if one or more of the listed attributes contain the passed value. You may also surround the value with '/' and '/' to perform a regular expression search rather than a containment operation. Any record that matches will be returned. The attributes searched are: range_value, range_type, ping_sweep_ind (1, 0), discovery_status (INCLUDE, EXCLUDE, IGNORE).
             :type query: String
        ...
        """Lists the available discovery settings matching the input specification. This provides the most flexible search specification of all the query mechanisms, enabling searching using comparison operations other than equality. However, it is more complex to use and will not perform as efficiently as the index or search methods. In the input descriptions below, 'field names' refers to the following fields: UnitID, blackout_duration, cidr_count, created_at, created_by, discovery_status, id, ping_sweep_ind, port_control_blackout_duration, range_end, range_end_numeric, range_mask, range_start, range_start_numeric, range_type, range_value, smart_ping_sweep_ind, start_blackout_schedule, start_port_control_blackout_schedule, updated_at, updated_by, virtual_network_id.
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param val_c_cidr_count: If op_cidr_count is specified, this value will be compared to the value in cidr_count using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_cidr_count must be specified if op_cidr_count is specified. If the rlike or not rlike value is specified in the op_cidr_count field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_discovery_status: If op_discovery_status is specified, this value will be compared to the value in discovery_status using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_discovery_status must be specified if op_discovery_status is specified. If the rlike or not rlike value is specified in the op_discovery_status field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_range_end: If op_range_end is specified, this value will be compared to the value in range_end using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_range_end must be specified if op_range_end is specified. If the rlike or not rlike value is specified in the op_range_end field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_range_end_numeric: If op_range_end_numeric is specified, this value will be compared to the value in range_end_numeric using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_range_end_numeric must be specified if op_range_end_numeric is specified. If the rlike or not rlike value is specified in the op_range_end_numeric field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_range_mask: If op_range_mask is specified, this value will be compared to the value in range_mask using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_range_mask must be specified if op_range_mask is specified. If the rlike or not rlike value is specified in the op_range_mask field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_range_start: If op_range_start is specified, this value will be compared to the value in range_start using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_range_start must be specified if op_range_start is specified. If the rlike or not rlike value is specified in the op_range_start field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_range_type: If op_range_type is specified, this value will be compared to the value in range_type using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_range_type must be specified if op_range_type is specified. If the rlike or not rlike value is specified in the op_range_type field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_range_value: If op_range_value is specified, this value will be compared to the value in range_value using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_range_value must be specified if op_range_value is specified. If the rlike or not rlike value is specified in the op_range_value field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_smart_ping_sweep_ind: If op_smart_ping_sweep_ind is specified, this value will be compared to the value in smart_ping_sweep_ind using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_smart_ping_sweep_ind must be specified if op_smart_ping_sweep_ind is specified. If the rlike or not rlike value is specified in the op_smart_ping_sweep_ind field, escape regex special characters because a regular expression is expected.
