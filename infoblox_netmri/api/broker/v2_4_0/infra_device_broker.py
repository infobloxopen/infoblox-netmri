...
class InfraDeviceBroker(Broker):
    ...
    def index(self, **kwargs):
        """Lists the available infra devices. Any of the inputs listed may be used to narrow the list; other inputs will be ignored. Of the various ways to query lists, using this method is most efficient.
        ...
        """Lists the available infra devices matching the input specification. This provides the most flexible search specification of all the query mechanisms, enabling searching using comparison operations other than equality. However, it is more complex to use and will not perform as efficiently as the index or search methods. In the input descriptions below, 'field names' refers to the following fields: DataSourceID, DeviceAddlInfo, DeviceAssurance, DeviceConfigLastCheckedTime, DeviceConfigTimestamp, DeviceContextName, DeviceDNSName, DeviceFirstOccurrenceTime, DeviceID, DeviceIPDotted, DeviceIPNumeric, DeviceMAC, DeviceModel, DeviceName, DeviceNetBIOSName, DeviceOUI, DevicePolicyScheduleMode, DeviceRebootTime, DeviceRunningConfigLastChangedTime, DeviceSAAVersion, DeviceSavedConfigLastChangedTime, DeviceSysContact, DeviceSysDescr, DeviceSysLocation, DeviceSysName, DeviceType, DeviceUniqueKey, DeviceVendor, DeviceVersion, FilterProvisionData, FilteringInd, InfraDeviceChangedCols, InfraDeviceEndTime, InfraDeviceStartTime, InfraDeviceTimestamp, MgmtServerDeviceID, NetworkDeviceInd, ParentDeviceID, RoutingInd, SwitchingInd, VirtualInd, VirtualNetworkID, VirtualNetworkingInd.
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param val_c_DeviceConfigLastCheckedTime: If op_DeviceConfigLastCheckedTime is specified, this value will be compared to the value in DeviceConfigLastCheckedTime using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_DeviceConfigLastCheckedTime must be specified if op_DeviceConfigLastCheckedTime is specified. If the rlike or not rlike value is specified in the op_DeviceConfigLastCheckedTime field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_DeviceSavedConfigLastChangedTime: If op_DeviceSavedConfigLastChangedTime is specified, this value will be compared to the value in DeviceSavedConfigLastChangedTime using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_DeviceSavedConfigLastChangedTime must be specified if op_DeviceSavedConfigLastChangedTime is specified. If the rlike or not rlike value is specified in the op_DeviceSavedConfigLastChangedTime field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_FilterProvisionData: If op_FilterProvisionData is specified, this value will be compared to the value in FilterProvisionData using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_FilterProvisionData must be specified if op_FilterProvisionData is specified. If the rlike or not rlike value is specified in the op_FilterProvisionData field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_InfraDeviceStartTime: If op_InfraDeviceStartTime is specified, this value will be compared to the value in InfraDeviceStartTime using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_InfraDeviceStartTime must be specified if op_InfraDeviceStartTime is specified. If the rlike or not rlike value is specified in the op_InfraDeviceStartTime field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_VirtualNetworkingInd: If op_VirtualNetworkingInd is specified, this value will be compared to the value in VirtualNetworkingInd using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_VirtualNetworkingInd must be specified if op_VirtualNetworkingInd is specified. If the rlike or not rlike value is specified in the op_VirtualNetworkingInd field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_available_mgmt_ips: If op_available_mgmt_ips is specified, this value will be compared to the value in available_mgmt_ips using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_available_mgmt_ips must be specified if op_available_mgmt_ips is specified. If the rlike or not rlike value is specified in the op_available_mgmt_ips field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_chassis_serial_number: If op_chassis_serial_number is specified, this value will be compared to the value in chassis_serial_number using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_chassis_serial_number must be specified if op_chassis_serial_number is specified. If the rlike or not rlike value is specified in the op_chassis_serial_number field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_rawSysDescr: If op_rawSysDescr is specified, this value will be compared to the value in rawSysDescr using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_rawSysDescr must be specified if op_rawSysDescr is specified. If the rlike or not rlike value is specified in the op_rawSysDescr field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_rawSysModel: If op_rawSysModel is specified, this value will be compared to the value in rawSysModel using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_rawSysModel must be specified if op_rawSysModel is specified. If the rlike or not rlike value is specified in the op_rawSysModel field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_rawSysVersion: If op_rawSysVersion is specified, this value will be compared to the value in rawSysVersion using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_rawSysVersion must be specified if op_rawSysVersion is specified. If the rlike or not rlike value is specified in the op_rawSysVersion field, escape regex special characters because a regular expression is expected.
        ...
        """Updates an existing infra device.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return uri: The URI that may be used to retrieve the updated infra device.
             :rtype uri: String
        ...
        """The combined comma separated serial numbers reported by the chassis snmp MIB.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return chassis_serial_number: The combined comma separated serial numbers reported by the chassis snmp MIB.
             :rtype chassis_serial_number: String
        ...
        """Available Management IPs for a device.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return available_mgmt_ips: Available Management IPs for a device.
             :rtype available_mgmt_ips: Array
        ...
        """The general Device object corresponding to this infrastructure device.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return device: The general Device object corresponding to this infrastructure device.
             :rtype device: Device
        ...
        """The settings information for this device
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return device_setting: The settings information for this device
        ...
        """Capabilities of configuring the interfaces of this device.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return control_capabilities: Capabilities of configuring the interfaces of this device.
        ...
        """Unprocessed Device Model value as returned by SNMP
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return rawSysModel: Unprocessed Device Model value as returned by SNMP
             :rtype rawSysModel: String
        ...
        """Unprocessed Device Version value as returned by SNMP
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return rawSysVersion: Unprocessed Device Version value as returned by SNMP
             :rtype rawSysVersion: String
        ...
        """Unprocessed Device Description value as returned by SNMP
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return rawSysDescr: Unprocessed Device Description value as returned by SNMP
             :rtype rawSysDescr: String
