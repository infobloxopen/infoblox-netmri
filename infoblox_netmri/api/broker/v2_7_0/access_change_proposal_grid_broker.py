        ...
        """Lists the available access change proposal grids. Any of the inputs listed may be be used to narrow the list; other inputs will be ignored. Of the various ways to query lists, using this method is most efficient.
            ...
            **Inputs**
            ...
            |  ``default:`` id
             ...
             :param sort: The data field(s) to use for sorting the output. Default is id. Valid values are id, DeviceID, ProposalID, DeviceType, DeviceAssurance, DeviceName, DeviceIPDotted, Network, VirtualNetworkID, DeviceIPNumeric, DeviceFilterSetID, DeviceFilterSetName, RuleNum, RuleNumEditableInd, SrcObjID, SrcObjName, SrcMatchedObjNames, SrcObjSummary, SrcObjEditableInd, SrcObjHasDetailInd, DestObjID, DestObjName, DestMatchedObjNames, DestObjSummary, DestObjEditableInd, DestObjHasDetailInd, SvcID, SvcName, SvcMatchedObjNames, SvcSummary, SvcEditableInd, SvcHasDetailInd, SrcSvcName, Action, Warning, WarningMsg, WarningMsgHasDetailInd, ConfigurationDetails, SrcGroupTag, DestGroupTag, SvcGroupTag.
            ...
            |  ``default:`` None
             ...
             :param select: The list of attributes to return for each AccessChangeProposalGrid. Valid values are id, DeviceID, ProposalID, DeviceType, DeviceAssurance, DeviceName, DeviceIPDotted, Network, VirtualNetworkID, DeviceIPNumeric, DeviceFilterSetID, DeviceFilterSetName, RuleNum, RuleNumEditableInd, SrcObjID, SrcObjName, SrcMatchedObjNames, SrcObjSummary, SrcObjEditableInd, SrcObjHasDetailInd, DestObjID, DestObjName, DestMatchedObjNames, DestObjSummary, DestObjEditableInd, DestObjHasDetailInd, SvcID, SvcName, SvcMatchedObjNames, SvcSummary, SvcEditableInd, SvcHasDetailInd, SrcSvcName, Action, Warning, WarningMsg, WarningMsgHasDetailInd, ConfigurationDetails, SrcGroupTag, DestGroupTag, SvcGroupTag. If empty or omitted, all attributes will be returned.
             :type select: Array
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return access_change_proposal_grids: An array of the AccessChangeProposalGrid objects that match the specified input criteria.
             :rtype access_change_proposal_grids: Array of AccessChangeProposalGrid
