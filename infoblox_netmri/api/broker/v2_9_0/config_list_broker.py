...
class ConfigListBroker(Broker):
    ...
    def index(self, **kwargs):
        """Lists the available config lists. Any of the inputs listed may be used to narrow the list; other inputs will be ignored. Of the various ways to query lists, using this method is most efficient.
            ...
            **Inputs**
            ...
            |  ``default:`` id
             ...
             :param sort: The data field(s) to use for sorting the output. Valid values are id, auth_user_id, name, description, created_at, updated_at.
        ...
        """This method will return all rows which are assigned to specific list.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return rows: List of all rows which are assigned to specific list
             :rtype rows: Array
        ...
        """This method will create a config list.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return list: Created config list
             :rtype list: Hash
        ...
        """This method will update selected list.
            ...
            **Inputs**
            ...
            |  ``default:`` 0
             ...
             :param id: The internal NetMRI identifier for the list. A new config list will be created if ID is not passed.
             :type id: Integer
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return id: The internal identifier for the list
             :rtype id: Integer
            ...
            |  ``default:`` None
             ...
             :return description: Description of the list
             :rtype description: String
        ...
        """This method will update all rows which are assigned to selected list.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return columns: New columns info, if exists
             :rtype columns: Array of Hash
            ...
            |  ``default:`` None
             ...
             :return rows: New rows info, if exists
             :rtype rows: Array of Hash

            """

        return self.api_list_request(self._get_method_fullname("update_rows"), kwargs)
        ...
        """This method will create or replace a list with input from a CSV file.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return id: The internal NetMRI identifier for the list
             :rtype id: Integer
        ...
        """For the given list this method will find the first occurrence (row) of the value key_value in the column key_column.
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param key_value: Value which will be searched in the column
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return value_column: If found, for the row, return the value in the column value_column. If not found, return default
             :rtype value_column: String

            """

        return self.api_request(self._get_method_fullname("find_column"), kwargs)

    def search_rows(self, **kwargs):
        """Search config list rows
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param id: The internal NetMRI identifier for the list. Either id or name is required.
             :type id: Integer
            ...
            |  ``default:`` None
             ...
             :param name: The name of the config list. Either id or name is required.
             :type name: String
            ...
            |  ``default:`` None
             ...
             :param list_columns: Each list column to be matched should be included as a separate input, starting the name with $ (no actual input named list_columns is needed). For example, you can match the column 'foo' of a list to 'bar' by passing $foo as the input name, along with the value 'bar'.
             :type list_columns: String
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return list_rows: The config list rows that were matched. Each array entry represents a row, with the row being a hash with list column names for keys (without a $), plus an entry 'id' that contains the list_row_id for use in other API calls.
             :rtype list_rows: Array of Hash

            """

        return self.api_request(self._get_method_fullname("search_rows"), kwargs)

    def update_row(self, **kwargs):
        """Update a row in a config list
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param list_row_id: The internal NetMRI identifier for the list row
             :type list_row_id: Integer
            ...
            |  ``default:`` None
             ...
             :param list_columns: Each list column to be updated should be included as a separate input, starting the name with $ (no actual input named list_columns is needed). For example, you can update the column 'foo' of a list to 'bar' by passing $foo as the input name, along with the value 'bar'.
             :type list_columns: String
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return list_row: The updated row of the config list. This is a hash with list column names for keys (without a $), plus an entry 'id' with the list_row_id.
             :rtype list_row: Hash

            """

        return self.api_request(self._get_method_fullname("update_row"), kwargs)

    def destroy_rows(self, **kwargs):
        """Delete rows from a config list
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param list_row_id: An array of the internal NetMRI identifiers for the list row(s).
             :type list_row_id: Array of Integer
        ...
        return self.api_request(self._get_method_fullname("destroy_rows"), kwargs)
        ...
        """Create a row in a config list
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return list_row: The config list row that was created.
             :rtype list_row: Hash

            """

        return self.api_request(self._get_method_fullname("create_row"), kwargs)

    def create_column(self, **kwargs):
        """Create a column for a config list
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return list_column: The config list column created.
             :rtype list_column: Hash

            """

        return self.api_request(self._get_method_fullname("create_column"), kwargs)
