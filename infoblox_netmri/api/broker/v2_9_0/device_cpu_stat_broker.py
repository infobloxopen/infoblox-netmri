...
class DeviceCpuStatBroker(Broker):
    ...
    def index(self, **kwargs):
        """Lists the available device cpu stats. Any of the inputs listed may be used to narrow the list; other inputs will be ignored. Of the various ways to query lists, using this method is most efficient.
            ...
            **Inputs**
            ...
            |  ``default:`` DeviceCpuStatsID
             ...
             :param sort: The data field(s) to use for sorting the output. Valid values are DeviceCpuStatsID, DataSourceID, DeviceID, StartTime, EndTime, CpuIndex, CpuBusy.
        ...
        """Lists the available device cpu stats matching the input specification. This provides the most flexible search specification of all the query mechanisms, enabling searching using comparison operations other than equality. However, it is more complex to use and will not perform as efficiently as the index or search methods. In the input descriptions below, 'field names' refers to the following fields: CpuBusy, CpuIndex, DataSourceID, DeviceCpuStatsID, DeviceID, EndTime, StartTime.
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param val_c_CpuBusy: If op_CpuBusy is specified, this value will be compared to the value in CpuBusy using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_CpuBusy must be specified if op_CpuBusy is specified. If the rlike or not rlike value is specified in the op_CpuBusy field, escape regex special characters because a regular expression is expected.
