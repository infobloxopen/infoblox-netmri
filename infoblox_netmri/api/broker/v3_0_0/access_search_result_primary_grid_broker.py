        ...
        """Lists the available access search result primary grids. Any of the inputs listed may be be used to narrow the list; other inputs will be ignored. Of the various ways to query lists, using this method is most efficient.
            ...
            **Inputs**
            ...
            |  ``default:`` id
             ...
             :param sort: The data field(s) to use for sorting the output. Default is id. Valid values are id, Status, DeviceID, DeviceType, DeviceAssurance, DeviceDNSName, DeviceName, DeviceIPDotted, Network, VirtualNetworkID, DeviceIPNumeric, DeviceFilterSetID, ESearchID, DeviceFilterSetName, Access, RuleID, MatchCount, StatusPct, ErrorMsg, updated_at.
            ...
            |  ``default:`` None
             ...
             :param select: The list of attributes to return for each AccessSearchResultPrimaryGrid. Valid values are id, Status, DeviceID, DeviceType, DeviceAssurance, DeviceDNSName, DeviceName, DeviceIPDotted, Network, VirtualNetworkID, DeviceIPNumeric, DeviceFilterSetID, ESearchID, DeviceFilterSetName, Access, RuleID, MatchCount, StatusPct, ErrorMsg, updated_at. If empty or omitted, all attributes will be returned.
             :type select: Array
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return access_search_result_primary_grids: An array of the AccessSearchResultPrimaryGrid objects that match the specified input criteria.
             :rtype access_search_result_primary_grids: Array of AccessSearchResultPrimaryGrid
