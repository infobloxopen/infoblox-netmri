...
class JobProcessBroker(Broker):
    ...
    def index(self, **kwargs):
        """Lists the available job processes. Any of the inputs listed may be used to narrow the list; other inputs will be ignored. Of the various ways to query lists, using this method is most efficient.
            ...
            **Inputs**
            ...
            |  ``default:`` id
             ...
             :param sort: The data field(s) to use for sorting the output. Valid values are id, process_type, user_name, job_handler_id, job_id, input_data, status, last_status_at, started_at, completed_at, created_at, updated_at, revert_ind, deploy_ind, device_id.
        ...
        """Lists the available job processes matching the input specification. This provides the most flexible search specification of all the query mechanisms, enabling searching using comparison operations other than equality. However, it is more complex to use and will not perform as efficiently as the index or search methods. In the input descriptions below, 'field names' refers to the following fields: completed_at, created_at, deploy_ind, device_id, id, input_data, job_handler_id, job_id, last_status_at, process_type, revert_ind, started_at, status, updated_at, user_name.
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param val_c_deploy_ind: If op_deploy_ind is specified, this value will be compared to the value in deploy_ind using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_deploy_ind must be specified if op_deploy_ind is specified. If the rlike or not rlike value is specified in the op_deploy_ind field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_job_handler_id: If op_job_handler_id is specified, this value will be compared to the value in job_handler_id using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_job_handler_id must be specified if op_job_handler_id is specified. If the rlike or not rlike value is specified in the op_job_handler_id field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_job_id: If op_job_id is specified, this value will be compared to the value in job_id using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_job_id must be specified if op_job_id is specified. If the rlike or not rlike value is specified in the op_job_id field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_process_type: If op_process_type is specified, this value will be compared to the value in process_type using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_process_type must be specified if op_process_type is specified. If the rlike or not rlike value is specified in the op_process_type field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_revert_ind: If op_revert_ind is specified, this value will be compared to the value in revert_ind using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_revert_ind must be specified if op_revert_ind is specified. If the rlike or not rlike value is specified in the op_revert_ind field, escape regex special characters because a regular expression is expected.
        ...
        """The device against which this Process will be executed.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return device: The device against which this Process will be executed.
             :rtype device: Device
