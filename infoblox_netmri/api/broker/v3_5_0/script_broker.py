        ...
        """Lists the available scripts matching the input specification. This provides the most flexible search specification of all the query mechanisms, enabling searching using comparison operations other than equality. However, it is more complex to use and will not perform as efficiently as the index or search methods. In the input descriptions below, 'field names' refers to the following fields: category, created_at, created_by, description, id, language, module, name, read_only, risk_level, target_mapping, taskflow_create, taskflow_edit, taskflow_revert, transactional_ind, updated_at, updated_by, visible.
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param val_c_target_mapping: If op_target_mapping is specified, this value will be compared to the value in target_mapping using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_target_mapping must be specified if op_target_mapping is specified. If the rlike or not rlike value is specified in the op_target_mapping field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_taskflow_create: If op_taskflow_create is specified, this value will be compared to the value in taskflow_create using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_taskflow_create must be specified if op_taskflow_create is specified. If the rlike or not rlike value is specified in the op_taskflow_create field, escape regex special characters because a regular expression is expected.
        ...
        """Import a CCS/Perl/Python script into the server.
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param script_name: The name of the script. Required if ID is not passed.
            ...
            |  ``default:`` None
             ...
             :param language: The language of the script. Required if ID is not passed. Possible values: Python/Perl/CCS
             :type language: String
