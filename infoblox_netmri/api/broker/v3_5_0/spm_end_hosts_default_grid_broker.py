...
class SpmEndHostsDefaultGridBroker(Broker):
    controller = "spm_end_hosts_default_grids"

    def index(self, **kwargs):
        """Lists the available spm end hosts default grids. Any of the inputs listed may be used to narrow the list; other inputs will be ignored. Of the various ways to query lists, using this method is most efficient.
            ...
            **Inputs**
            ...
            |  ``default:`` today
             ...
             :param starttime: The data returned will represent the spm end hosts default grids with this date and time as lower boundary. If omitted, the result will indicate the most recently collected data.
            ...
            |  ``default:`` tomorrow
             ...
             :param endtime: The data returned will represent the spm end hosts default grids with this date and time as upper boundary. If omitted, the result will indicate the most recently collected data.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return spm_end_hosts_default_grids: An array of the SpmEndHostsDefaultGrid objects that match the specified input criteria.
             :rtype spm_end_hosts_default_grids: Array of SpmEndHostsDefaultGrid
