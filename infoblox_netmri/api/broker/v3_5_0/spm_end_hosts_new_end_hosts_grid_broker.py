...
class SpmEndHostsNewEndHostsGridBroker(Broker):
    ...
    def index(self, **kwargs):
        """Lists the available spm end hosts new end hosts grids. Any of the inputs listed may be used to narrow the list; other inputs will be ignored. Of the various ways to query lists, using this method is most efficient.
            ...
            **Inputs**
            ...
            |  ``default:`` today
             ...
             :param starttime: The data returned will represent the spm end hosts new end hosts grids with this date and time as lower boundary. If omitted, the result will indicate the most recently collected data.
            ...
            |  ``default:`` tomorrow
             ...
             :param endtime: The data returned will represent the spm end hosts new end hosts grids with this date and time as upper boundary. If omitted, the result will indicate the most recently collected data.
            ...
            |  ``default:`` None
             ...
             :param select: The list of attributes to return for each SpmEndHostsNewEndHostsGrid. Valid values are id, VirtualNetworkID, NeighborDeviceID, NeighborType, NeighborIPDotted, NeighborIPNumeric, Network, NeighborName, NeighborMAC, NeighborIfIndex, OrgUniqueId, NetBIOSName, FirstSeen, LastSeen, DeviceID, DeviceType, DeviceName, DeviceIPDotted, DeviceIPNumeric, InterfaceID, Interface, VirtualNetworkMemberName, ifIndex, ifDescr, ifAlias, ifMAC, ifAdminStatus, ifOperStatus, ifSpeed, ifAdminDuplex, ifDuplex, VlanIndex, VlanName, VlanID, VTPDomain, TenantDn, BridgeDomainDn, EPGDn, ApName, ApIpAddress, ApSsid, Packets, Errors, ErrorPercentage. If empty or omitted, all attributes will be returned.
             :type select: Array
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return spm_end_hosts_new_end_hosts_grids: An array of the SpmEndHostsNewEndHostsGrid objects that match the specified input criteria.
             :rtype spm_end_hosts_new_end_hosts_grids: Array of SpmEndHostsNewEndHostsGrid
