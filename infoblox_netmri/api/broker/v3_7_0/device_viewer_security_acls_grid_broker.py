        ...
        """Lists the available device viewer security acls grids. Any of the inputs listed may be be used to narrow the list; other inputs will be ignored. Of the various ways to query lists, using this method is most efficient.
            ...
            **Inputs**
            ...
            |  ``default:`` id
             ...
             :param sort: The data field(s) to use for sorting the output. Default is id. Valid values are id, DeviceID, DeviceFilterSetID, AccessList, ifName, ifNameSort, ifIndex, Direction.
            ...
            |  ``default:`` None
             ...
             :param select: The list of attributes to return for each DeviceViewerSecurityAclsGrid. Valid values are id, DeviceID, DeviceFilterSetID, AccessList, ifName, ifNameSort, ifIndex, Direction. If empty or omitted, all attributes will be returned.
             :type select: Array
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return device_viewer_security_acls_grids: An array of the DeviceViewerSecurityAclsGrid objects that match the specified input criteria.
             :rtype device_viewer_security_acls_grids: Array of DeviceViewerSecurityAclsGrid
