...
class ScanInterfaceBroker(Broker):
        ...
        """Creates a Virtual Scan Interface
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param search_domains: Domain suffixes for DNS resolving.
    ...
    def import_file(self, **kwargs):
        """Imports a list of scan interface from a file
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param file: The contents of the CSV file with the list of scan interfaces to be imported
             :type file: String
