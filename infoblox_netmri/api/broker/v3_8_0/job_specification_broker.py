        ...
        """Lists the available job specifications matching the input specification. This provides the most flexible search specification of all the query mechanisms, enabling searching using comparison operations other than equality. However, it is more complex to use and will not perform as efficiently as the index or search methods. In the input descriptions below, 'field names' refers to the following fields: approval_note, approved_by, approved_by_name, approved_timestamp, category, config_template_id, created_at, created_by, deployable_ind, description, id, job_type, last_run, name, provision_data, push_mode, revertable_ind, schedule, script, script_id, transactional_ind, unapproved_notification_trigger, updated_at.
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param val_c_approved_timestamp: If op_approved_timestamp is specified, this value will be compared to the value in approved_timestamp using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_approved_timestamp must be specified if op_approved_timestamp is specified. If the rlike or not rlike value is specified in the op_approved_timestamp field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_deployable_ind: If op_deployable_ind is specified, this value will be compared to the value in deployable_ind using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_deployable_ind must be specified if op_deployable_ind is specified. If the rlike or not rlike value is specified in the op_deployable_ind field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_push_mode: If op_push_mode is specified, this value will be compared to the value in push_mode using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_push_mode must be specified if op_push_mode is specified. If the rlike or not rlike value is specified in the op_push_mode field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_revertable_ind: If op_revertable_ind is specified, this value will be compared to the value in revertable_ind using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_revertable_ind must be specified if op_revertable_ind is specified. If the rlike or not rlike value is specified in the op_revertable_ind field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_script: If op_script is specified, this value will be compared to the value in script using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_script must be specified if op_script is specified. If the rlike or not rlike value is specified in the op_script field, escape regex special characters because a regular expression is expected.
        ...
        """Rerun a script
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param last_run_batch_id: Identifier of the batch of execution of last run.
             :type last_run_batch_id: Integer
            ...
            |  ``default:`` None
             ...
             :param schedule: If launched for later, the schedule information. nil or empty for no schedule. No schedule means run now
             :type schedule: String
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return job_id: The job_id of the launched script or template, or 0 if the purpose is only to re-schedule.
