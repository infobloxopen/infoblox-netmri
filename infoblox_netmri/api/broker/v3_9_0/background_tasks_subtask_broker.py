...
class BackgroundTasksSubtaskBroker(Broker):
    ...
    def index(self, **kwargs):
        """Lists the available background tasks subtasks. Any of the inputs listed may be used to narrow the list; other inputs will be ignored. Of the various ways to query lists, using this method is most efficient.
            ...
            **Inputs**
            ...
            |  ``default:`` id
             ...
             :param sort: The data field(s) to use for sorting the output. Valid values are id, background_task_id, name, status, detail, created_at, updated_at.
        ...
        """Lists the available background tasks subtasks matching the input specification. This provides the most flexible search specification of all the query mechanisms, enabling searching using comparison operations other than equality. However, it is more complex to use and will not perform as efficiently as the index or search methods. In the input descriptions below, 'field names' refers to the following fields: background_task_id, created_at, detail, id, name, status, updated_at.
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param val_c_background_task_id: If op_background_task_id is specified, this value will be compared to the value in background_task_id using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_background_task_id must be specified if op_background_task_id is specified. If the rlike or not rlike value is specified in the op_background_task_id field, escape regex special characters because a regular expression is expected.
        ...
        """Creates a new background tasks subtask.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return uri: The URI that may be used to retrieve the newly created background tasks subtask.
             :rtype uri: String
        ...
        """Updates an existing background tasks subtask.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return uri: The URI that may be used to retrieve the updated background tasks subtask.
             :rtype uri: String
