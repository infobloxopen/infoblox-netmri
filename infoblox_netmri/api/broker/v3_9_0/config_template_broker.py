...
class ConfigTemplateBroker(Broker):
    ...
    def show(self, **kwargs):
        """Shows the details for the specified config template.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return config_template: The config template identified by the specified id.
    ...
    def template_text(self, **kwargs):
        """The text of the config template.
        ...
        return self.api_request(self._get_method_fullname("template_text"), kwargs)
    ...
    def show_with_details(self, **kwargs):
        ...
        return self.api_request(self._get_method_fullname("show_with_details"), kwargs)
    ...
    def merge(self, **kwargs):
        """Merges the specified template with the list of passed in variables.
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param id: The ID of the template to merge. Ignored if template_text is passed; required if template_text is not passed.
             :type id: Integer
            ...
            |  ``default:`` None
             ...
             :param template_variables: Each variable to be merged should be included as a separate input, starting the name with $ (no actual input named template_variables is needed). For example, you can set the variable 'foo' to 'bar' by passing '$foo' as the input name, along with the value 'bar'. Any occurrence of '$foo' in the template_text will be replaced by the text 'bar'.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return template_text: The text of the template, merged with the passed variables. Variables found in the template that are not resolved will remain in the text, allowing multiple merge operations in series.
             :rtype template_text: String

            """

        return self.api_request(self._get_method_fullname("merge"), kwargs)

    def merge_to_file(self, **kwargs):
        """Merges the specified template with the list of passed in variables and returns result configuration file. If multiple Device IDs are passed, the resulting file will be a ZIP archive containing a text file for each device. If a single DeviceID is passed, the resulting file will be a text file for that device.
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param device_ids: A comma delimited string of device IDs.
            ...
            |  ``default:`` None
             ...
             :param device_group_ids: A comma delimited string of device group IDs.
        ...
        return self.api_request(self._get_method_fullname("merge_to_file"), kwargs)
