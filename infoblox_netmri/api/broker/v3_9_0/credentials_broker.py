...
class CredentialsBroker(Broker):
    ...
    def get_cli_credentials(self, **kwargs):
        """Shows device CLI credentials
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return config.SSH.Username: CLI SSH username, if exists
             :rtype config.SSH.Username: String
            ...
            |  ``default:`` None
             ...
             :return config.SSH.Password: CLI SSH password, if exists
             :rtype config.SSH.Password: String
            ...
            |  ``default:`` None
             ...
             :return config.SSH.Port: CLI SSH port, if exists
             :rtype config.SSH.Port: Integer
            ...
            |  ``default:`` None
             ...
             :return config.Telnet.Username: CLI Telnet username, if exists
             :rtype config.Telnet.Username: String
            ...
            |  ``default:`` None
             ...
             :return config.Telnet.Password: CLI Telnet password, if exists
             :rtype config.Telnet.Password: String
            ...
            |  ``default:`` None
             ...
             :return config.Telnet.Port: CLI Telnet port, if exists
             :rtype config.Telnet.Port: Integer
            ...
            |  ``default:`` None
             ...
             :return config.HTTP.Username: CLI HTTP username, if exists
             :rtype config.HTTP.Username: String
            ...
            |  ``default:`` None
             ...
             :return config.HTTP.Password: CLI HTTP password, if exists
             :rtype config.HTTP.Password: String
            ...
            |  ``default:`` None
             ...
             :return config.EnablePassword: CLI enable password, if exists
             :rtype config.EnablePassword: String

            """

        return self.api_request(self._get_method_fullname("get_cli_credentials"), kwargs)
