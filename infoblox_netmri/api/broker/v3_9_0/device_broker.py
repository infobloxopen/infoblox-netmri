...
class DeviceBroker(Broker):
        ...
        """Lists the available devices matching the input specification. This provides the most flexible search specification of all the query mechanisms, enabling searching using comparison operations other than equality. However, it is more complex to use and will not perform as efficiently as the index or search methods. In the input descriptions below, 'field names' refers to the following fields: DataSourceID, DeviceAddlInfo, DeviceAssurance, DeviceChangedCols, DeviceDNSName, DeviceEndTime, DeviceFirstOccurrenceTime, DeviceID, DeviceIPDotted, DeviceIPNumeric, DeviceMAC, DeviceModel, DeviceName, DeviceNetBIOSName, DeviceOUI, DeviceStartTime, DeviceSysContact, DeviceSysDescr, DeviceSysLocation, DeviceSysName, DeviceTimestamp, DeviceType, DeviceUniqueKey, DeviceVendor, DeviceVersion, InfraDeviceInd, MgmtServerDeviceID, NetworkDeviceInd, ParentDeviceID, VirtualInd, VirtualNetworkID.
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param val_c_DeviceFirstOccurrenceTime: If op_DeviceFirstOccurrenceTime is specified, this value will be compared to the value in DeviceFirstOccurrenceTime using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_DeviceFirstOccurrenceTime must be specified if op_DeviceFirstOccurrenceTime is specified. If the rlike or not rlike value is specified in the op_DeviceFirstOccurrenceTime field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_DeviceUniqueKey: If op_DeviceUniqueKey is specified, this value will be compared to the value in DeviceUniqueKey using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_DeviceUniqueKey must be specified if op_DeviceUniqueKey is specified. If the rlike or not rlike value is specified in the op_DeviceUniqueKey field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_InfraDeviceInd: If op_InfraDeviceInd is specified, this value will be compared to the value in InfraDeviceInd using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_InfraDeviceInd must be specified if op_InfraDeviceInd is specified. If the rlike or not rlike value is specified in the op_InfraDeviceInd field, escape regex special characters because a regular expression is expected.
    ...
    def poll_status(self, **kwargs):
        """Poll on Demand Status
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param id: The internal NetMRI identifier for previously initiated poll.
             :type id: String
        ...
        return self.api_request(self._get_method_fullname("poll_status"), kwargs)
        ...
        """Remove many devices, with the option to remove them from discovery
            ...
            **Inputs**
            ...
            |  ``default:`` False
             ...
             :param black_list_ind: Set to 1 if you want to add devices to Black List
             :type black_list_ind: Boolean
            ...
            |  ``default:`` False
             ...
             :param delete_duplicates_ind: Set to 1 if you want to delete device instances on other collectors
             :type delete_duplicates_ind: Boolean
    ...
    def build_access_diff_tree(self, **kwargs):
        """prepare a diff-compute for that device, return an array of tree element, prepared for jstree viewer, diff identifier is on the root of each tree
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param DeviceID: The internal identifier of the device.
             :type DeviceID: Integer
            ...
            |  ``default:`` None
             ...
             :param starttime: timestamp of the configuration first border of the diff
            ...
            |  ``default:`` None
             ...
             :param endtime: timestamp of the configuration last border of the diff
            ...
            |  ``default:`` tree
             ...
             :param formatting: specified format of the output: html, text, or tree. Defaults to tree
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return elements: The asked modified elements, in a diff-tree format.
             :rtype elements: Array

            """

        return self.api_request(self._get_method_fullname("build_access_diff_tree"), kwargs)

    def access_diff_impact_tree(self, **kwargs):
        """ask for impacted elements of a specified element, needs to have an already computed access_diffi, output format as Array of tree
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param diff_identifier: Identifier of the diff computer
             :type diff_identifier: String
            ...
            |  ``default:`` None
             ...
             :param element_id: Identifier of element for which we look after the impacted
            ...
            |  ``default:`` None
             ...
             :param element_type: Type of element for which we look after the impacted
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return impacted: The asked impacted elements, in a diff-tree format.
             :rtype impacted: Array

            """

        return self.api_request(self._get_method_fullname("access_diff_impact_tree"), kwargs)

    def build_access_diff(self, **kwargs):
        """Retrieve existing access diff or build a new one, return the id for status info and result
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return diff_identifier: The id of diff for reuse in access_diff_impact calls.
             :rtype diff_identifier: String

            """

        return self.api_request(self._get_method_fullname("build_access_diff"), kwargs)

    def access_diff_building_status(self, **kwargs):
        """Return information about status of current building an access diff
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return status: one of : Unknown, Building, Done
             :rtype status: String
            ...
            |  ``default:`` None
             ...
             :return completion: a value from 0 to 100 that indicates rate or ended building process
             :rtype completion: Integer
            ...
            |  ``default:`` None
             ...
             :return step: description of current step
             :rtype step: String

            """

        return self.api_request(self._get_method_fullname("access_diff_building_status"), kwargs)

    def access_diff_tree(self, **kwargs):
        """Return an array of tree element, prepared for jstree viewer, diff identifier is on the root of each tree. The diff-computer for that device MUST already exist
        ...
        return self.api_request(self._get_method_fullname("access_diff_tree"), kwargs)

    def access_diff_impact(self, **kwargs):
        """ask for impacted elements of a specified element, needs to have an already computed access_diff
        ...
        """Discovery Diagnostics
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param DeviceID: The internal NetMRI identifier of the device for which the diagnostic tests should be performed.
             :type DeviceID: Integer
            ...
            |  ``default:`` None
             ...
             :param ip_address: IP Address to diagnose. Required if no 'DeviceID' is specified.
             :type ip_address: String
            ...
            |  ``default:`` None
             ...
             :param community: SNMP community string to use
            ...
            |  ``default:`` False
             ...
             :param force_ind: When false, the tests to execute will be determined based upon the results of previous run tests When true, all tests will be run.
             :type force_ind: Boolean
            ...
            |  ``default:`` True
             ...
             :param poll_ind: When true, an attempt will be made to poll the device for all data supported by the device
             :type poll_ind: Boolean
            ...
            |  ``default:`` False
             ...
             :param async_ind: When false, the diagnostic will be run synchronously, and the API call will block until it is complete. When true, diagnostic id will be returned to use for subsequent calls
             :type async_ind: Boolean
            ...
            |  ``default:`` True
             ...
             :param debug_snmp_ind: When false, the snmp debug will be turned off
             :type debug_snmp_ind: Boolean
            ...
            |  ``default:`` False
             ...
             :param ut_flag: True if Netmri should not really poll given device
             :type ut_flag: Boolean
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return text: When async_ind is false, diagnostic test text will be returned upon completion.
             :rtype text: String
            ...
            |  ``default:`` None
             ...
             :return id: The internal NetMRI identifier for previously initiated diagnostic test.
             :rtype id: String

            """

        return self.api_request(self._get_method_fullname("diagnostic"), kwargs)
        ...
        """Discovery Diagnostics Status
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param id: The internal NetMRI identifier for previously initiated diagnostic test.
             :type id: String
            ...
            |  ``default:`` None
             ...
             :param start: The starting index(inclusive) of the returned text of the diagnostic test.
             :type start: Integer
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return text: Diagnostic test text from the start index.
             :rtype text: String
            ...
            |  ``default:`` None
             ...
             :return start: The starting index(inclusive) of the returned text of the diagnostic test.
             :rtype start: Integer
            ...
            |  ``default:`` None
             ...
             :return end: The ending index (exclusive) of the returned text of the diagnostic test.
             :rtype end: Integer

            """

        return self.api_request(self._get_method_fullname("diagnostic_status"), kwargs)

    def update_device_properties(self, **kwargs):
        """Updates device properties
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param DeviceID: The internal NetMRI device identifier to update.
             :type DeviceID: Integer
            ...
            |  ``default:`` None
             ...
             :param privileged_polling: A flag indicated that NetMRI should send enable command when interacting with device.
             :type privileged_polling: Integer

            **Outputs**

            """

        return self.api_request(self._get_method_fullname("update_device_properties"), kwargs)

    def change_device_management_ip(self, **kwargs):
        """Changes device management IP
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param management_ip: New management IP
             :type management_ip: String
            ...
            |  ``default:`` None
             ...
             :param management_virtual_network_id: New virtual network ID. Needed in case of new management address is in different network view
             :type management_virtual_network_id: Integer

            **Outputs**

            """

        return self.api_request(self._get_method_fullname("change_device_management_ip"), kwargs)

    def move_device_to_collector(self, **kwargs):
        """Set another management collector for the device
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param DeviceID: The internal NetMRI device identifier to be moved to a new collector.
             :type DeviceID: Integer
            ...
            |  ``default:`` None
             ...
             :param NewUnitID: ID of the collector to move the device to.
             :type NewUnitID: Integer

            **Outputs**

            """

        return self.api_request(self._get_method_fullname("move_device_to_collector"), kwargs)
