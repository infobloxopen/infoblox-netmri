...
class FailOverConfigurationBroker(Broker):
    ...
    def update_mgmt_servername(self, **kwargs):
        """Update Servername in FO metadata if it was changed
        ...
        return self.api_request(self._get_method_fullname("update_mgmt_servername"), kwargs)

    def update_mgmt_ip(self, **kwargs):
        """Update IP address in FO metadata if it was changed
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param old_mgmt_ip_address: The old IP address of MGMT interface
             :type old_mgmt_ip_address: String
            ...
            |  ``default:`` None
             ...
             :param new_mgmt_ip_address: The new IP address of MGMT interface
             :type new_mgmt_ip_address: String
        ...
        return self.api_request(self._get_method_fullname("update_mgmt_ip"), kwargs)
