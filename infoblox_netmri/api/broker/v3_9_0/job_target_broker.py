...
class JobTargetBroker(Broker):
    ...
    def index(self, **kwargs):
        """Lists the available job targets. Any of the inputs listed may be used to narrow the list; other inputs will be ignored. Of the various ways to query lists, using this method is most efficient.
        ...
        """Lists the available job targets matching the input specification. This provides the most flexible search specification of all the query mechanisms, enabling searching using comparison operations other than equality. However, it is more complex to use and will not perform as efficiently as the index or search methods. In the input descriptions below, 'field names' refers to the following fields: completed_at, created_at, device_filter_set_id, device_group_id, device_id, dis_session_id, id, input_data, interface_group_id, interface_id, job_id, job_specification_id, last_status_at, managed_process_id, status, status_info, target_type, updated_at.
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param val_c_dis_session_id: If op_dis_session_id is specified, this value will be compared to the value in dis_session_id using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_dis_session_id must be specified if op_dis_session_id is specified. If the rlike or not rlike value is specified in the op_dis_session_id field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_interface_id: If op_interface_id is specified, this value will be compared to the value in interface_id using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_interface_id must be specified if op_interface_id is specified. If the rlike or not rlike value is specified in the op_interface_id field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_status_info: If op_status_info is specified, this value will be compared to the value in status_info using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_status_info must be specified if op_status_info is specified. If the rlike or not rlike value is specified in the op_status_info field, escape regex special characters because a regular expression is expected.
            ...
            |  ``default:`` None
             ...
             :param val_c_target_type: If op_target_type is specified, this value will be compared to the value in target_type using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_target_type must be specified if op_target_type is specified. If the rlike or not rlike value is specified in the op_target_type field, escape regex special characters because a regular expression is expected.
