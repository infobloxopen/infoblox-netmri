...
class PolicyBroker(Broker):
        ...
        """Creates a new policy.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return uri: The URI that may be used to retrieve the newly created policy.
             :rtype uri: String
        ...
        """Updates an existing policy.
            ...
            **Outputs**
            ...
            |  ``default:`` None
             ...
             :return uri: The URI that may be used to retrieve the updated policy.
             :rtype uri: String
    ...
    def index(self, **kwargs):
        """Lists the available policies. Any of the inputs listed may be used to narrow the list; other inputs will be ignored. Of the various ways to query lists, using this method is most efficient.
            ...
            **Inputs**
            ...
            |  ``default:`` id
             ...
             :param sort: The data field(s) to use for sorting the output. Valid values are id, name, description, author, set_filter, created_at, updated_at, schedule_mode, short_name, read_only.
        ...
        """Lists the available policies matching the input specification. This provides the most flexible search specification of all the query mechanisms, enabling searching using comparison operations other than equality. However, it is more complex to use and will not perform as efficiently as the index or search methods. In the input descriptions below, 'field names' refers to the following fields: author, created_at, description, id, name, read_only, schedule_mode, set_filter, short_name, updated_at.
            ...
            **Inputs**
            ...
            |  ``default:`` None
             ...
             :param val_c_schedule_mode: If op_schedule_mode is specified, this value will be compared to the value in schedule_mode using the specified operator. The value in this input will be treated as an explicit constant value. Either this field or val_f_schedule_mode must be specified if op_schedule_mode is specified. If the rlike or not rlike value is specified in the op_schedule_mode field, escape regex special characters because a regular expression is expected.
    ...
    def export_file(self, **kwargs):
        """Export policies and associated policy rules to a file
