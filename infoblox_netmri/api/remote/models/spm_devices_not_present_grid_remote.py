...
class SpmDevicesNotPresentGridRemote(RemoteModel):
    """
    This table lists SPM devices that were last seen by NetMRI before but not during the user specified period of time.
