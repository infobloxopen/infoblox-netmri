...
class SpmDevicesSlowDevicesGridRemote(RemoteModel):
    """
     This table lists all SPM devices that existed within the user specified period of time sorted by the Poll Duration in descending order.
