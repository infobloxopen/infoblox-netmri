...
class SpmEndHostsDefaultGridRemote(RemoteModel):
    """
    This table lists an entry for all end hosts NetMRI has discovered, including virtual machines, that existed within the user specified period of time.
