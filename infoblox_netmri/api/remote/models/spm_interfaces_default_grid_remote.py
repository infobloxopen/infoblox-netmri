...
class SpmInterfacesDefaultGridRemote(RemoteModel):
    """
    This table lists all SPM interfaces that existed within the user specified period of time.
    ...
    |  ``DeviceIPNumeric:`` The numerical value of the IP address for the device associated with this interface.
    |  ``attribute type:`` number
    ...
    |  ``ifDescr:`` The description of this interface, as set in the device's configuration file.
    |  ``attribute type:`` string

    |  ``ifAlias:`` Interface alias for this interface.
    |  ``attribute type:`` string

    |  ``ifType:`` The interface type for this interface.
    |  ``attribute type:`` string
