...
class SpmInterfacesLinkChangesGridRemote(RemoteModel):
    """
    This table lists all SPM interfaces for which the link speed or status changed within the user specified period of time.
    ...
    |  ``SwitchingInd:`` Switching indicator
    |  ``attribute type:`` bool

    |  ``SPMLicensedInd:`` SPM Licensed indicator
    |  ``attribute type:`` bool
